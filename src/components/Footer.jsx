...
function Footer() {
  return (
    <div className='w-full h-screen p-16 flex bg-zinc-900'>
        <div className='w-1/2 flex flex-col justify-between h-full'>
          <div className='heading mt-5'>
             <h1 className='text-[5vw] font-semibold tracking-tight leading-[.8]'>EYE-</h1>
             <h1 className='text-[5vw] font-semibold tracking-tight leading-[.8]'>OPENINGS</h1>
          </div>
        ...
        <div className='w-1/2 mt-5'>
          <h1 className='text-[5vw] font-semibold tracking-tight leading-[.8]'>PRESENTATIONS</h1>
         <div className='details py-5'>
             <h1 className='py-5'>S:</h1>
             <a  className='block text-sm' href='#'> Instagram</a>
             <a  className='block text-sm' href='#'> Facebook</a>
             <a  className='block text-sm' href='#'> Behance</a>
             <a  className='block text-sm' href='#'> Linkedin</a>
         </div>

         <div className='details py-5'>
             <h1 className='py-5'>L:</h1>
             <a  className='block text-sm' href='#'> 202-102-W 4th Avue</a>
             <a  className='block text-sm' href='#'> Vancouver, Canada</a>
             <a  className='block text-sm' href='#'> 30 Chukarina st </a>
         </div>

         <div className='details py-5'>
             <h1 className='py-5'>E:</h1>
             <a  className='block text-sm' href='#'> hello@ochi.com</a>
             
         </div>

        </div>
 
        <div className='details py-8 relative top-12 h-0 w-32 right-32'>
             <h1 className='py-5'>M:</h1>
             <a  className='block text-sm' href='#'> Home</a>
             <a  className='block text-sm' href='#'> Services</a>
             <a  className='block text-sm' href='#'> Our work</a>
             <a  className='block text-sm' href='#'> About us</a>
             <a  className='block text-sm' href='#'> Insights</a>
             <a  className='block text-sm' href='#'> Contact us</a>
